...
class EvalCallback(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None, callback=None):
        temp_epoch = epoch + 1
        if epoch % self.period == 0 and self.eval_flag:
            ...
            print('name:mAP0.5', 'value:', temp_map)
            # tf.summary.scalar('mAP0.5', temp_map, step=temp_epoch)  # add
            with callback.as_default():
                tf.summary.scalar('mAP0.5', temp_map, step=temp_epoch)
                callback.flush()
